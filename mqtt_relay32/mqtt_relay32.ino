...
#define PIN_RLY 17 /* Relay control pin (output) */
#define PIN_BTN 18 /* Button pin (input) */
#define PIN_CLK 22 /* TM1637 clock pin (output) */
#define PIN_DIO 21 /* TM1637 data pin (output) */
#define PIN_ERR 20 /* Error LED pin (output) */
...
const IPAddress ip(192, 168, 1, 6);
